...
scheduler_events = {
	"cron": {
		# Nightly at 3:00 AM (after Bridge Server's 2:00 AM transmission)
		"0 3 * * *": [
			"nigeria_compliance_client.nigeria_compliance_client.hooks.sales_invoice.sync_pending_b2c_statuses_from_bridge"
		]
	}
}
